...
import com.baseframe.common.MapperKey;
import com.baseframe.common.annotation.Authority;
import com.baseframe.common.utils.AnnotationUtil;
import com.baseframe.common.utils.JsonConvertUtil;
...
public class OperationService extends AbstratService<AuthOperation> {
	// 扫描包
	private static final String PERMISS_PACKAGE = "com.baseframe.controller";
